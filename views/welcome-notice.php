<div class="notice notice-info">
    ...
    <ul>
        ...
        <li><?php echo sprintf(__( "Then configure the appearance of your page : the header banner, the default colors of your links or the background color of your page from the tab <a href='%s'>Appareance</a>", 'linky' ), admin_url('admin.php?page=' . $this->_getMenuSlug($this->_appareanceMenuSlug))); ?></li>
        ...
        <li><?php echo sprintf(__( "Finally, <a href='%s'>configure your links</a> and view the result!", 'linky' ), admin_url('admin.php?page=' . $this->_getMenuSlug($this->_linksMenuSlug))); ?></li>
    </ul>
