<div class="notice notice-info">
    ...
    <ul>
        ...
        <li><?php echo sprintf(__( "Then configure the appearance of your page : the header banner, the default colors of your links or the background color of your page from the tab <a href='%s'>Appearance</a>", 'linky' ), admin_url('admin.php?page=' . $this->_getMenuSlug($this->_appareanceMenuSlug))); ?></li>
