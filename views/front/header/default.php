<div class="header-wrapper <?php echo $page->get('social_display') == 'yes' ? 'is-social-hide' : ''; ?>">
        ...
        <?php if(!$socials->isEmpty()): ?>
            <nav class="header__social-bar <?php echo $page->get('social_display') == 'yes' ? 'social-hide' : ''; ?>">
                <?php foreach ($socials->getAll() as $social => $value): ?>
                    <?php if(!empty($value)): ?>
                        <a href="<?php echo $value; ?>" class="<?php echo sanitize_title($social); ?>" title="<?php echo ucfirst($social); ?>" style="fill: <?php echo $textColor ?>">
